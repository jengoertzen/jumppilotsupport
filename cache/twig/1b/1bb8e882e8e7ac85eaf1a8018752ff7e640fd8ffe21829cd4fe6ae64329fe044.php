...
class __TwigTemplate_765639891aa01db2b93625f0de379c1507916f2af1879c116eee4ee70524ffda extends Twig_Template
{
...
";
    ...
    public function block_input($context, array $blocks = array())
    {
        ...
        <select name=\"";
        // line 10
        echo ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->fieldNameFilter((($context["scope"] ?? null) . $this->getAttribute(($context["field"] ?? null), "name", array()))) . (($this->getAttribute(($context["field"] ?? null), "multiple", array())) ? ("[]") : ("")));
        echo "\"
                class=\"";
        // line 11
        ...
        if ($this->getAttribute(($context["field"] ?? null), "form", array())) {
            echo "form=\"";
            echo $this->getAttribute(($context["field"] ?? null), "form", array());
            echo "\"";
        }
        // line 21
        echo "                ";
        ...
        if ($this->getAttribute(($context["field"] ?? null), "placeholder", array())) {
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) {
                echo call_user_func_array($this->env->getFilter('tu')->getCallable(), array($this->getAttribute(($context["field"] ?? null), "placeholder", array())));
            } else {
...
{% endblock %}
", "forms/fields/select/select.html.twig", "/home/vagrant/Code/jumppilotsupport/web/user/plugins/form/templates/forms/fields/select/select.html.twig");
    }
}
